...
if ($action === 'get_applications') {
    ...
    if (!$result) {
        // Try with prepared statement if direct query fails
    ...
    echo json_encode(['success' => true, 'applications' => mysqli_fetch_all($result, MYSQLI_ASSOC)]);
    exit;
}
